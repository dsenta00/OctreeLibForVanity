...
#include "..\..\..\Library\Engine\Scene\Transforms\Position.h"
#include "..\..\..\Library\Engine\Scene\Transforms\Projection Transform.h"

#include "..\..\..\Library\Engine\Lighting\Material.h"
#include "..\..\..\Library\Engine\Lighting\Directional Light.h"
...
namespace vxe
{
	...
	private:
		std::shared_ptr<VertexShader<DirectX::VertexPositionNormal>> _vertexshader;
		std::shared_ptr<PixelShader> _pixelshader;

		std::shared_ptr<MeshBase<DirectX::VertexPositionNormal, unsigned short>> _model;
