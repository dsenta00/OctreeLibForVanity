	...
	m_deviceResources(deviceResources)
{
	...
	ThrowIfFailed(m_deviceResources->GetD2DFactory()->CreateDrawingStateBlock(&m_stateBlock), __FILEW__, __LINE__);
...
{
	ThrowIfFailed(m_deviceResources->GetD2DDeviceContext()->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::White), &m_whiteBrush), __FILEW__, __LINE__);
}
